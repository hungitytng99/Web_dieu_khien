      ...
      <div class="wrap-login100 p-t-30 p-b-50">
        ...
        <form class="login100-form validate-form p-b-33 p-t-5" action="" method="post">
          ...
          <div class="wrap-input100 validate-input" data-validate = "Enter email">
            <input class="input100" id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus placeholder="Email">
...
<!-- 
          ...
          <div class="pull-left" style="margin-top: 20px;font-family: courier; font-size: 150%;">
            <a class="btn btn-primary" style="font-size: 20px;"  href="/">     LOGIN</a>
          </div>
        @if (session('error'))
